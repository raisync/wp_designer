<?php
/**
 * @class productPostsModule
 */
class productPostsModule extends FLBuilderModule {
	...
	public function __construct()
	{
		parent::__construct(array(
			'name'          	=> __('Product Featured', 'fl-builder'),
 ...
 */
FLBuilder::register_module('productPostsModule', array(
	'slides'         => array(
