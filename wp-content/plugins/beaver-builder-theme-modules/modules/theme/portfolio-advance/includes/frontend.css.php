...
.fl-node-<?php echo $id; ?> .portfolio-items article figure {
    padding-top: 100%;
...
.fl-node-<?php echo $id; ?> .portfolio-button:hover {
    color: #BE8D5E;
...
.fl-node-<?php echo $id; ?> .portfolio-filter .active { 
...
.fl-node-<?php echo $id; ?> .portfolio-items article figure .portfolio-button {
    color: #5c5c5c;
...
.fl-node-<?php echo $id; ?> .portfolio-items article figure .portfolio-button:hover {
