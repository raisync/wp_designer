.fl-node-<?php echo $id; ?> .heading-link {
...
.fl-node-<?php echo $id; ?> .icon-lg,
.fl-node-<?php echo $id; ?> <?php echo $settings->tag; ?>.heading-link a,
.fl-node-<?php echo $id; ?> <?php echo $settings->tag; ?>.heading-link .heading-link-text,
.fl-node-<?php echo $id; ?> <?php echo $settings->tag; ?>.heading-link .heading-link-text * {
...
.fl-node-<?php echo $id; ?> <?php echo $settings->tag; ?>.heading-link a:hover {
	color: #<?php echo $settings->h_color; ?>;
}
<?php endif; ?>

<?php if( !empty($settings->font) && $settings->font['family'] != 'Default' ) : ?>
.fl-node-<?php echo $id; ?> .heading-link .heading-link-text{
...
@media (max-width: <?php echo $global_settings->responsive_breakpoint; ?>px) {
	...
	.fl-node-<?php echo $id; ?>.fl-module-heading .heading-link {
