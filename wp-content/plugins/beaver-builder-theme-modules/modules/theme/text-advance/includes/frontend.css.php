...
.fl-node-<?php echo $id; ?> .section-heading {
	text-align: <?php echo $settings->alignment; ?>;
    <?php if($settings->font_size == 'default') : ?>
	font-size: 18px;
	<?php endif; ?>
...
.fl-node-<?php echo $id; ?> h2.section-heading .section-heading-text em,
.fl-node-<?php echo $id; ?> h2.section-heading .section-heading-text span,
.fl-node-<?php echo $id; ?> h2.section-heading .section-heading-text b,
.fl-node-<?php echo $id; ?> h2.section-heading .section-heading-text strong,
.fl-node-<?php echo $id; ?> h2.section-heading .section-heading-text i {
