...
/**
 * @class customTextModule
 */
class customTextModule extends FLBuilderModule {
	...
	public function __construct()
	{
		parent::__construct(array(
			'name'          	=> __('Custom Text - Advance', 'fl-builder'),
			'description'   	=> __('Display a custom text.', 'fl-builder'),
 ...
 */
FLBuilder::register_module('customTextModule', array(
	'general'       => array(
            ...
            'alignment'          => array(
				...
				'fields'        => array(
                    'color'          => array(
                        ...
                        'preview'         => array(
							'type'            => 'css',
							'selector'        => 'h2.section-heading .section-heading-text',
                            'property'        => 'color'
						)	
					),
                    'opacity' => array(
                    ...
                    'h_color'          => array(
						'type'          => 'color',
						'show_reset'    => true,
						'label'         => __('Text Highlight Color', 'fl-builder'),
                        'preview'         => array(
                            'type'            => 'css',
                            'rules'        => array(
                                array(
                                    'selector'        => 'h2.section-heading .section-heading-text em',
                                    'property'        => 'color',
                                ),
                                array(
                                    'selector'        => 'h2.section-heading .section-heading-text i',
                                    'property'        => 'color',
                                ),
                                array(
                                    'selector'        => 'h2.section-heading .section-heading-text b',
                                    'property'        => 'color',
                                ),
                                array(
                                    'selector'        => 'h2.section-heading .section-heading-text span',
                                    'property'        => 'color',
                                )
                            )
						)
