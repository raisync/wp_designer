<?php
/**
 * @class advancePostsModule
 */
class advancePostsModule extends FLBuilderModule {
	...
	public function __construct()
	{
		parent::__construct(array(
			'name'          	=> __('Advance Posts', 'fl-builder'),
	...
	{
		$classname = 'posts-mixitup' . $this->settings->layout;
		return $classname;
	}
}

/*Testimonial Avatar Size*/
add_image_size( 'posts-mixitup', 366 , 366, true );

/**
 * Register the module and its form settings.
 */
FLBuilder::register_module('advancePostsModule', array(
	'slides'         => array(
		...
		'sections'      => array(
			'general'       => array(
				...
				'fields'        => array(
					...
					'totalpost'         => array(
						'type'          => 'text',
						'label'         => __('Number of Posts to display', 'fl-builder'),
                    ...
                    'show_excerpt'     => array(
						...
						'toggle'        => array(
							'true'        => array(
								'fields'        => array('str_limit')
							)
						)
					),
                    'title_str_limit' => array(
						'type'          => 'text',
						'label'         => __('Post Title Text Limit', 'fl-builder'),
						'default'       => '20',
						'maxlength'     => '3',
						'size'          => '4',
